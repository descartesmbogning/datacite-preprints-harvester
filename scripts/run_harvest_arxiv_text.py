...
resource_type_id = "text"     #_ALLOWED_TYPES = {"preprint","text","Dataset","Software","Image","Collection","Event","Model","Sound","PhysicalObject","Workflow","Other"}
...
if __name__ == "__main__":
    ...
    df = harvest_datacite_preprints_dataframe(
        ...
        date_end=date_end,
        client_ids=["arxiv.content"],                      # or ["arxiv.content", "cern.zenodo", ...]
        #
